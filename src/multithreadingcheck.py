...
#         self.clist = list()
#         self.ilist = list()
#         self.t2 = Thread(target=self.f2).start()
#         time.sleep(5)
#         self.t = Thread(target=self.f).start()
#
#     def f3(self, *args):
#         for i in args:
#             i.start()
...
def parse_args():
    ...
    parser.add_argument('--host', default='52.70.61.124',
                        required=False, action='store',
    ...
    parser.add_argument('--data0', default="TATASTEEL_STK_NSE",
                        required=False, action='store',
    ...
    parser.add_argument('--timeframe', default=bt.TimeFrame.Names[4],
